# Lowdown AUTHORING — DISCO CHAT 2026 draft
...
register; league theme: Operational / CRC.
...
3. `rough-lowdown.md` — ONLY when the workflow explicitly requests the rough
   ...
   It MUST begin with `<!-- ROUGH DRAFT - COMMISSIONER EDIT REQUIRED -->` and cannot publish; the
