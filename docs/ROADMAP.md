...
| 7c | **Move every authoring route to the store** | 9 | `shipped` 2026-09-07 — all 35, proved structurally and by fault injection |
| 7d | **Import editorial state, then decide** | 9 | `gated` — dry run clean; see docs/CUTOVER.md |
